...
def huffman_encoding(data):
    ...
    while queue.size() > 1:
        ...
        queue.push(internal_node, frequency)

    if len(data) == 1:
        dummy_node = Node(1, None)
        dummy_node.left = queue.pop()
        queue.push(dummy_node, 1)
...
if __name__ == "__main__":
    ...
    print("===== Test 2 Udacity sample =====")
    another_sentence = "AAAAAAABBBCCCCCCCDDEEEEEE"
    ...
    print("===== Test 3 single characters =====")
    another_sentence = "A"
    ...
    print("===== Test 4 handle empty strings =====")
    another_sentence = ""
